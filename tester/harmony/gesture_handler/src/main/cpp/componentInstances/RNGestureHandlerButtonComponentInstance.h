...
#include "../generated/RNOH/generated/components/BaseRNGestureHandlerButtonComponentInstance.h"

namespace rnoh {
class RNGestureHandlerButtonComponentInstance
    : public BaseRNGestureHandlerButtonComponentInstance {
    using Super = BaseRNGestureHandlerButtonComponentInstance;
public:
